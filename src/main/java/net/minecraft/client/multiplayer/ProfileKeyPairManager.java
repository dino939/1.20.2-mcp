...
public interface ProfileKeyPairManager {
   ...
   static ProfileKeyPairManager create(UserApiService p_253925_, User p_254501_, Path p_254206_) {
      return (ProfileKeyPairManager)(p_254501_.getType() == User.Type.MSA ? new AccountProfileKeyPairManager(p_253925_, p_254501_.getProfileId(), p_254206_) : EMPTY_KEY_MANAGER);
   }
