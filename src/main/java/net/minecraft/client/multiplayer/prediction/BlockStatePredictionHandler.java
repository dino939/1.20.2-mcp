...
public class BlockStatePredictionHandler implements AutoCloseable {
   ...
   public void retainKnownServerState(BlockPos p_233868_, BlockState p_233869_, LocalPlayer p_233870_) {
      this.serverVerifiedStates.compute(p_233868_.asLong(), (p_296243_, p_296244_) -> {
         return p_296244_ != null ? p_296244_.setSequence(this.currentSequenceNr) : new BlockStatePredictionHandler.ServerVerifiedState(this.currentSequenceNr, p_233869_, p_233870_.position());
      });
   }
