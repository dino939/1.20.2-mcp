...
public class StructureRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void addBoundingBox(BoundingBox p_113683_, List<StructuresDebugPayload.PieceInfo> p_113684_, ResourceKey<Level> p_297588_) {
      this.postMainBoxes.computeIfAbsent(p_297588_, (p_299944_) -> {
         return new HashMap();
      }).put(p_113683_.toString(), p_113683_);
      Map<String, StructuresDebugPayload.PieceInfo> map = this.postPieces.computeIfAbsent(p_297588_, (p_298617_) -> {
         return new HashMap();
      });
