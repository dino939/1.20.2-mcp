...
public record GuiMetadataSection(GuiSpriteScaling scaling) {
   ...
   public static final Codec<GuiMetadataSection> CODEC = RecordCodecBuilder.create((p_301140_) -> {
      return p_301140_.group(ExtraCodecs.strictOptionalField(GuiSpriteScaling.CODEC, "scaling", GuiSpriteScaling.DEFAULT).forGetter(GuiMetadataSection::scaling)).apply(p_301140_, GuiMetadataSection::new);
   });
