...
public class RecipeToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics p_281667_, ToastComponent p_281321_, long p_281779_) {
      ...
      if (this.recipes.isEmpty()) {
         ...
         RecipeHolder<?> recipeholder = this.recipes.get((int)((double)p_281779_ / Math.max(1.0D, 5000.0D * p_281321_.getNotificationDisplayTimeMultiplier() / (double)this.recipes.size()) % (double)this.recipes.size()));
