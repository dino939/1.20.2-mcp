...
public class BanNoticeScreens {
   ...
   public static ConfirmLinkScreen createNameBan(String p_300838_, Runnable p_297249_) {
      ...
      return new ConfirmLinkScreen((p_299238_) -> {
         ...
         p_297249_.run();
      }, NAME_BAN_TITLE, Component.translatable("gui.banned.name.description", Component.literal(p_300838_).withStyle(ChatFormatting.YELLOW), "https://aka.ms/mcjavamoderation"), "https://aka.ms/mcjavamoderation", CommonComponents.GUI_ACKNOWLEDGE, true);
   }
