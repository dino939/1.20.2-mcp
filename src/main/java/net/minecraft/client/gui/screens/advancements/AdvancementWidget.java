...
public class AdvancementWidget {
   ...
   public void draw(GuiGraphics p_281958_, int p_281323_, int p_283679_) {
      if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
         ...
         p_281958_.blitSprite(advancementwidgettype.frameSprite(this.display.getFrame()), p_281323_ + this.x + 3, p_283679_ + this.y, 26, 26);
   ...
   public void drawHover(GuiGraphics p_283068_, int p_281304_, int p_281253_, float p_281848_, int p_282097_, int p_281537_) {
      ...
      p_283068_.blitSprite(advancementwidgettype2.frameSprite(this.display.getFrame()), p_281304_ + this.x + 3, p_281253_ + this.y, 26, 26);
      if (flag) {
