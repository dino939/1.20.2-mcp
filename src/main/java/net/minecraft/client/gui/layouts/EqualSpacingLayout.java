...
public class EqualSpacingLayout extends AbstractLayout {
   ...
   public void visitChildren(Consumer<LayoutElement> p_299750_) {
      this.children.forEach((p_298818_) -> {
         p_299750_.accept(p_298818_.child);
      });
   }
   ...
   public static enum Orientation {
      ...
      int getPrimaryLength(LayoutElement p_299718_) {
         ...
         switch (this) {
            case HORIZONTAL:
               i = p_299718_.getWidth();
               break;
            case VERTICAL:
               i = p_299718_.getHeight();
               break;
            default:
      ...
      int getPrimaryLength(EqualSpacingLayout.ChildContainer p_298044_) {
         ...
         switch (this) {
            case HORIZONTAL:
               i = p_298044_.getWidth();
               break;
            case VERTICAL:
               i = p_298044_.getHeight();
               break;
            default:
               throw new IncompatibleClassChangeError();
         }
      ...
      int getSecondaryLength(LayoutElement p_301361_) {
         ...
         switch (this) {
            case HORIZONTAL:
               i = p_301361_.getHeight();
               break;
            case VERTICAL:
               i = p_301361_.getWidth();
               break;
            default:
               throw new IncompatibleClassChangeError();
         }
      ...
      int getSecondaryLength(EqualSpacingLayout.ChildContainer p_297317_) {
         ...
         switch (this) {
            case HORIZONTAL:
               i = p_297317_.getHeight();
               break;
            case VERTICAL:
               i = p_297317_.getWidth();
               break;
            default:
               throw new IncompatibleClassChangeError();
         }
