...
public class References {
   ...
   public static final DSL.TypeReference SAVED_DATA_COMMAND_STORAGE = () -> {
      return "saved_data/command_storage";
   };
   public static final DSL.TypeReference SAVED_DATA_FORCED_CHUNKS = () -> {
      return "saved_data/chunks";
   };
   public static final DSL.TypeReference SAVED_DATA_MAP_DATA = () -> {
      return "saved_data/map_data";
   };
   public static final DSL.TypeReference SAVED_DATA_MAP_INDEX = () -> {
      return "saved_data/idcounts";
   };
   public static final DSL.TypeReference SAVED_DATA_RAIDS = () -> {
      return "saved_data/raids";
   };
   public static final DSL.TypeReference SAVED_DATA_RANDOM_SEQUENCES = () -> {
      return "saved_data/random_sequences";
   };
   public static final DSL.TypeReference SAVED_DATA_STRUCTURE_FEATURE_INDICES = () -> {
      return "saved_data/structure_feature_indices";
   };
   public static final DSL.TypeReference SAVED_DATA_SCOREBOARD = () -> {
