...
public class V1460 extends NamespacedSchema {
   ...
   public void registerTypes(Schema p_17660_, Map<String, Supplier<TypeTemplate>> p_17661_, Map<String, Supplier<TypeTemplate>> p_17662_) {
      ...
      p_17660_.registerType(false, References.SAVED_DATA_SCOREBOARD, () -> {
         return DSL.optionalFields("data", DSL.optionalFields("Objectives", DSL.list(References.OBJECTIVE.in(p_17660_)), "Teams", DSL.list(References.TEAM.in(p_17660_))));
      });
      p_17660_.registerType(false, References.SAVED_DATA_STRUCTURE_FEATURE_INDICES, () -> {
         return DSL.optionalFields("data", DSL.optionalFields("Features", DSL.compoundList(References.STRUCTURE_FEATURE.in(p_17660_))));
      });
