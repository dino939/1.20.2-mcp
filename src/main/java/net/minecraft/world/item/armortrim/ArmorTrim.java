...
public class ArmorTrim {
   ...
   public static Optional<ArmorTrim> getTrim(RegistryAccess p_266952_, ItemStack p_266766_, boolean p_297853_) {
      if (p_266766_.is(ItemTags.TRIMMABLE_ARMOR) && p_266766_.getTag() != null && p_266766_.getTag().contains("Trim")) {
         ...
         ArmorTrim armortrim = CODEC.parse(RegistryOps.create(NbtOps.INSTANCE, p_266952_), compoundtag).resultOrPartial((p_296895_) -> {
            if (!p_297853_) {
   ...
   public static void appendUpgradeHoverText(ItemStack p_266761_, RegistryAccess p_266979_, List<Component> p_267199_) {
      Optional<ArmorTrim> optional = getTrim(p_266979_, p_266761_, true);
