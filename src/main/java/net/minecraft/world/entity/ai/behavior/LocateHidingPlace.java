         ...
         return p_258505_.group(p_258505_.absent(MemoryModuleType.WALK_TARGET), p_258505_.registered(MemoryModuleType.HOME), p_258505_.registered(MemoryModuleType.HIDING_PLACE), p_258505_.registered(MemoryModuleType.PATH), p_258505_.registered(MemoryModuleType.LOOK_TARGET), p_258505_.registered(MemoryModuleType.BREED_TARGET), p_258505_.registered(MemoryModuleType.INTERACTION_TARGET)).apply(p_258505_, (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> {
            return (p_296696_, p_296697_, p_296698_) -> {
               p_296696_.getPoiManager().find((p_217258_) -> {
                  ...
                  return true;
               }, p_296697_.blockPosition(), p_259982_ + 1, PoiManager.Occupancy.ANY).filter((p_296704_) -> {
                  return p_296704_.closerToCenterThan(p_296697_.position(), (double)p_259982_);
               }).or(() -> {
                  return p_296696_.getPoiManager().getRandom((p_217256_) -> {
                     return p_217256_.is(PoiTypes.HOME);
                  }, (p_23421_) -> {
                     return true;
                  }, PoiManager.Occupancy.ANY, p_296697_.blockPosition(), p_259202_, p_296697_.getRandom());
               }).or(() -> {
                  ...
                  if (!p_296715_.closerToCenterThan(p_296697_.position(), (double)p_259982_)) {
                     p_258484_.set(new WalkTarget(p_296715_, p_259881_, p_259982_));
                  }
