   ...
   public Path createPath(BlockPos p_26475_, int p_26476_) {
      ...
      if (levelchunk == null) {
         ...
         if (levelchunk.getBlockState(p_26475_).isAir()) {
            BlockPos blockpos;
            for(blockpos = p_26475_.below(); blockpos.getY() > this.level.getMinBuildHeight() && levelchunk.getBlockState(blockpos).isAir(); blockpos = blockpos.below()) {
            }
         ...
         if (!levelchunk.getBlockState(p_26475_).isSolid()) {
            ...
            BlockPos blockpos1;
            for(blockpos1 = p_26475_.above(); blockpos1.getY() < this.level.getMaxBuildHeight() && levelchunk.getBlockState(blockpos1).isSolid(); blockpos1 = blockpos1.above()) {
            }
