...
public class CamelAi {
   ...
   private static void initIdleActivity(Brain<Camel> p_252342_) {
      p_252342_.addActivity(Activity.IDLE, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(1, new AnimalMakeLove(EntityType.CAMEL, 1.0F)), Pair.of(2, new RunOne<>(ImmutableList.of(Pair.of(new FollowTemptation((p_250812_) -> {
         return 2.5F;
      }, (p_296810_) -> {
   ...
   public static class RandomSitting extends Behavior<Camel> {
      ...
      protected boolean checkExtraStartConditions(ServerLevel p_249520_, Camel p_250322_) {
         return !p_250322_.isInWater() && p_250322_.getPoseTime() >= (long)this.minimalPoseTicks && !p_250322_.isLeashed() && p_250322_.onGround() && !p_250322_.hasControllingPassenger() && p_250322_.canCamelChangePose();
      }
