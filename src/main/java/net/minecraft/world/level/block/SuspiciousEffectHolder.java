...
public interface SuspiciousEffectHolder {
   ...
   public static record EffectEntry(MobEffect effect, int duration) {
      public static final Codec<SuspiciousEffectHolder.EffectEntry> CODEC = RecordCodecBuilder.create((p_298088_) -> {
         return p_298088_.group(BuiltInRegistries.MOB_EFFECT.byNameCodec().fieldOf("id").forGetter(SuspiciousEffectHolder.EffectEntry::effect), Codec.INT.optionalFieldOf("duration", Integer.valueOf(160)).forGetter(SuspiciousEffectHolder.EffectEntry::duration)).apply(p_298088_, SuspiciousEffectHolder.EffectEntry::new);
      });
