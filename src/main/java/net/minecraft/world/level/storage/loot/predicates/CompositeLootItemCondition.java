...
public abstract class CompositeLootItemCondition implements LootItemCondition {
   ...
   protected static <T extends CompositeLootItemCondition> Codec<T> createCodec(Function<List<LootItemCondition>, T> p_297590_) {
   ...
   protected static <T extends CompositeLootItemCondition> Codec<T> createInlineCodec(Function<List<LootItemCondition>, T> p_298800_) {
      return LootItemConditions.CODEC.listOf().xmap(p_298800_, (p_300100_) -> {
