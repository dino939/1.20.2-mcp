...
public abstract class LootItemConditionalFunction implements LootItemFunction {
   ...
   protected LootItemConditionalFunction(List<LootItemCondition> p_300620_) {
      ...
      this.compositePredicates = LootItemConditions.andConditions(p_300620_);
   }

   protected static <T extends LootItemConditionalFunction> Products.P1<RecordCodecBuilder.Mu<T>, List<LootItemCondition>> commonFields(RecordCodecBuilder.Instance<T> p_298596_) {
      return p_298596_.group(ExtraCodecs.strictOptionalField(LootItemConditions.CODEC.listOf(), "conditions", List.of()).forGetter((p_297561_) -> {
