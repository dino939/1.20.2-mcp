...
public abstract class LootPoolEntryContainer implements ComposableEntryContainer {
   ...
   protected LootPoolEntryContainer(List<LootItemCondition> p_298327_) {
      ...
      this.compositeCondition = LootItemConditions.andConditions(p_298327_);
   }

   protected static <T extends LootPoolEntryContainer> Products.P1<RecordCodecBuilder.Mu<T>, List<LootItemCondition>> commonFields(RecordCodecBuilder.Instance<T> p_297717_) {
      return p_297717_.group(ExtraCodecs.strictOptionalField(LootItemConditions.CODEC.listOf(), "conditions", List.of()).forGetter((p_297410_) -> {
