...
public class AlternativesEntry extends CompositeEntryBase {
   ...
   protected ComposableEntryContainer compose(List<? extends ComposableEntryContainer> p_298385_) {
      ...
      switch (p_298385_.size()) {
         case 0:
            composableentrycontainer = ALWAYS_FALSE;
            break;
         case 1:
            composableentrycontainer = p_298385_.get(0);
            break;
         case 2:
            composableentrycontainer = p_298385_.get(0).or(p_298385_.get(1));
            break;
         default:
            composableentrycontainer = (p_297016_, p_297017_) -> {
               for(ComposableEntryContainer composableentrycontainer1 : p_298385_) {
