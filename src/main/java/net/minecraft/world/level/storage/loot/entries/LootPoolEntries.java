...
public class LootPoolEntries {
   ...
   private static LootPoolEntryType register(String p_79630_, Codec<? extends LootPoolEntryContainer> p_300087_) {
      return Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(p_79630_), new LootPoolEntryType(p_300087_));
   }
}