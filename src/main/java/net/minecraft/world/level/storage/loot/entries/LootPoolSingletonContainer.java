...
public abstract class LootPoolSingletonContainer extends LootPoolEntryContainer {
   ...
   protected static <T extends LootPoolSingletonContainer> Products.P4<RecordCodecBuilder.Mu<T>, Integer, Integer, List<LootItemCondition>, List<LootItemFunction>> singletonFields(RecordCodecBuilder.Instance<T> p_299133_) {
      return p_299133_.group(ExtraCodecs.strictOptionalField(Codec.INT, "weight", 1).forGetter((p_300354_) -> {
         return p_300354_.weight;
      }), ExtraCodecs.strictOptionalField(Codec.INT, "quality", 0).forGetter((p_297680_) -> {
         return p_297680_.quality;
      })).and(commonFields(p_299133_).t1()).and(ExtraCodecs.strictOptionalField(LootItemFunctions.CODEC.listOf(), "functions", List.of()).forGetter((p_301387_) -> {
