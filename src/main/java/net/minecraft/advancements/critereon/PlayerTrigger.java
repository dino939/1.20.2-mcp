...
public class PlayerTrigger extends SimpleCriterionTrigger<PlayerTrigger.TriggerInstance> {
   public PlayerTrigger.TriggerInstance createInstance(JsonObject p_286911_, Optional<ContextAwarePredicate> p_301362_, DeserializationContext p_286261_) {
      return new PlayerTrigger.TriggerInstance(p_301362_);
   }
   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      public TriggerInstance(Optional<ContextAwarePredicate> p_298732_) {
         super(p_298732_);
      }
