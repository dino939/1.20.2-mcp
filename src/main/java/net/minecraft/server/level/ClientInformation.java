...
public record ClientInformation(String language, int viewDistance, ChatVisiblity chatVisibility, boolean chatColors, int modelCustomisation, HumanoidArm mainHand, boolean textFilteringEnabled, boolean allowsListing) {
   ...
   public ClientInformation(FriendlyByteBuf p_300049_) {
      this(p_300049_.readUtf(16), p_300049_.readByte(), p_300049_.readEnum(ChatVisiblity.class), p_300049_.readBoolean(), p_300049_.readUnsignedByte(), p_300049_.readEnum(HumanoidArm.class), p_300049_.readBoolean(), p_300049_.readBoolean());
   }
