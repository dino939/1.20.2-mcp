...
public class ServerFunctionManager {
   ...
   public int execute(CommandFunction p_136113_, CommandSourceStack p_136114_) {
      try {
         return this.execute(p_136113_, p_136114_, (ServerFunctionManager.TraceCallbacks)null, (CompoundTag)null);
   ...
   public int execute(CommandFunction p_179961_, CommandSourceStack p_179962_, @Nullable ServerFunctionManager.TraceCallbacks p_179963_, @Nullable CompoundTag p_300204_) throws FunctionInstantiationException {
      CommandFunction commandfunction = p_179961_.instantiate(p_300204_, this.getDispatcher(), p_179962_);
      if (this.context != null) {
         if (p_179963_ != null) {
            this.context.reportError(NO_RECURSIVE_TRACES.getString());
            return 0;
         } else {
            this.context.delayFunctionCall(commandfunction, p_179962_);
            return 0;
         }
      } else {
         int i;
         try {
            ...
            i = this.context.runTopCommand(commandfunction, p_179962_);
         } finally {
            this.context = null;
         }
